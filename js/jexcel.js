    ...
    var jexcel = (function(el, options) {
        ...
        var defaults = {
            ...
            text:{
                ...
                insertANewColumnBefore: '왼쪽에 새 열 추가하기',
                insertANewColumnAfter: '오른쪽에 새 열 추가하기',
                deleteSelectedColumns: '선택된 열을 제거하기',
                renameThisColumn: '선택된 열의 제목을 바꾸기',
        ...
        */
        ...
        // Context menu
        if (options && options.contextMenu == null) { // != 로 바꾸면 contextMenu 설정 가능
